...
TransparencyLabel.Size = UDim2.new(0.4, 0, 0.15, 0)
TransparencyLabel.Position = UDim2.new(0.05, 0, 0.78, 0)
...
local TransparencyBox = Instance.new("TextBox", Frame)
TransparencyBox.Size = UDim2.new(0.4, 0, 0.15, 0)
TransparencyBox.Position = UDim2.new(0.5, 0, 0.78, 0)
TransparencyBox.Text = "0.9"
TransparencyBox.TextColor3 = Color3.new(1, 1, 1)
TransparencyBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
-- ✅ Transparency input — update HitboxTransparency immediately
TransparencyBox.FocusLost:Connect(function(enterPressed)
    ...
    if val and val >= 0 and val <= 1 then
        ...
        TransparencyBox.Text = tostring(val)
    else
        TransparencyBox.Text = tostring(HitboxTransparency)
    end
end)
